...
%>
	...
	<html:form action="engageresume.do">
		<table width="100%">
			...
			<tr>
				<td align="right">
					<input type="button" class="SUBMIT_STYLE1" value="推荐面试" onclick="javascript:doEdit('${engageresumeForm.item.resId }');">
				...
				<tr>
					...
					<td class="TD_STYLE2">
						<html:select styleClass="SELECT_STYLE1"
							...
							<%
								vector = (Vector) ((HashMap) request.getAttribute("map")).get("宗教信仰");
								pageContext.setAttribute("vector", vector);
							%>
							<logic:iterate id="v" name="vector">
								<html:option value="${v}">${v}</html:option>
