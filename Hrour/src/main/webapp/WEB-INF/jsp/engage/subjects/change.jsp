...
<html>
	...
	<body>
		<html:form action="engagesubjects.do" method="post">
			<table width="100%">
				<tr>
					<td>
				...
				<tr>
					<td align="right">
						<input type="button" value="提交" class="BUTTON_STYLE1"
							onclick="javascript:doEdit(${engagesubjectsForm.item.subId });">
						<input type="button" value="返回" class="BUTTON_STYLE1"
							onclick="history.back();">
						<input type="button" value="删除" class="BUTTON_STYLE1"
							onclick="javascript:toDel('${engagesubjectsForm.item.subId }');">
					</td>
				</tr>
			</table>		
			...
			<table class="TABLE_STYLE1" border="1" width="100%" cellpadding=0
				...
				<tr class="TR_STYLE1">
					...
					<td width="14%" class="TD_STYLE2">
						<html:text property="item.register" styleClass="INPUT_STYLE2"></html:text>
					</td>
				...
				<tr>
					...
					<td class="TD_STYLE2">
						<html:text property="item.changer" styleClass="INPUT_STYLE2" value="${userName}"></html:text>
					</td>
					<td class="TD_STYLE1">
						变更时间
					</td>
					<td class="TD_STYLE2">
						<bean:write name="engagesubjectsForm" property="item.str_changeTime"/>
					</td>
				</tr>
			</table>
		</html:form>
