					...
					<span style="DISPLAY:none;" id="human_file">
						<table width="100%" border="0">
							...
							<tr>
								...
								<td>
									<a href="humanfile.do?operate=list&pageNow=1" target="mainFrame">人力资源档案登记复核</a>
								</td>
							</tr>
							<tr>
								<td>
									...
									<span style="DISPLAY:none;" id="human_file_delete">
										<table width="100%" border="0">
											...
											<tr>
												...
												<td width="98%">
													<a href="humanfile.do?operate=list&method=delforever&pageNow=1" target="mainFrame">人力资源档案永久删除</a>
												</td>
											</tr>
										</table> </span>
								</td>
					...
					<span style="DISPLAY:none;" id="major_change">
						<table width="100%" border="0">
							<tr>
								...
								<td width="98%">
									<a href="majorchange.do?operate=query" target="mainFrame">调动登记</a>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
										<a href="majorchange.do?operate=check&pageNow=1" target="mainFrame">调动审核</a>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<a href="majorchange.do?operate=queryAll&pageNow=1" target="mainFrame">调动查询</a>
								</td>
							</tr>
						</table> </span>
				</td>
