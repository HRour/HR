...
public class MajorChange implements Serializable {
	...
	private static final long serialVersionUID = 1874128672006002389L;
			...
			private Integer new_salary_standard_id ;
			private String new_salary_standard_name ;
			private Float new_salary_sum ;
			...
			public Integer getSalary_standard_id() {
				return salary_standard_id;
			}
			public void setSalary_standard_id(Integer salary_standard_id) {
			...
			public Integer getNew_salary_standard_id() {
				return new_salary_standard_id;
			}
			public void setNew_salary_standard_id(Integer new_salary_standard_id) {
			...
			public Float getNew_salary_sum() {
				return new_salary_sum;
			}
			public void setNew_salary_sum(Float new_salary_sum) {
